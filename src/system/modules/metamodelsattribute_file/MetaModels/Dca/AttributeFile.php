	...
	public function filePicker(DataContainerInterface $dc)
	{
		if (version_compare(VERSION, '3.1', '>='))
		{
			...
			return ' <a href="' . \Environment::getInstance()->base .
				'contao/file.php?do=' . \Input::get('do') . '&amp;table= ' . $dc->table . '&amp;field=' .
			$dc->field . '_' . $strId . '&amp;value=' . $currentField['path'][0] . '&mmfilepicker=1" title="' .
			...
			'\',\'tag\':\'ctrl_' . $dc->field . '_' . $strId . ((\Input::get('act') == 'editAll') ? '_' . $strId : '') .
